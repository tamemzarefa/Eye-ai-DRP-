...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      console.error('خطأ بإنشاء الحساب:', err)
    } finally {
      setLoading(false)
    }
  }
...
/>
        ...
        <div>
          <p className=" text-xl font-bold leading-relaxed text-gray-900">
            <span className="font-black " >Unlock</span>
            {' '}the full potential of AI to enhance and safeguard human vision
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            ...
            <button onClick={() => navigate('/login')} className="text-gray-900 font-semibold underline bg-transparent border-0 cursor-pointer font-sans">
              Login
            </button>
          </p>
        </div>
