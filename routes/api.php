...
Route::prefix('v1')->group(function (): void {
    ...
    Route::post('eye-ai/predict', [\App\Http\Controllers\Api\EyeAiController::class, 'predict'])
         ->name('eye-ai.predict');
    Route::post('eye-ai/segment', [\App\Http\Controllers\Api\EyeAiController::class, 'segment'])
         ->name('eye-ai.segment');
    Route::post('eye-ai/chat', [\App\Http\Controllers\Api\EyeAiController::class, 'chat'])
         ->name('eye-ai.chat');
